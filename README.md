...
### My name is Arden and I'm a Fullstack Developer based in Malmö, Sweden. <br>
...
Karla's choice // [Goodreads profile](https://www.goodreads.com/user/show/4239103-agent-x "Goodreads profile for Agent X") // [Arden Reads](https://arden-reads.com "Arden Reads")

- 🎮 _Games played recently?_ <br>
Diablo IV && Slay the Spire 2
...
## 🧩 Tech Stack
[![My Skills](https://skillicons.dev/icons?i=html,css,sass,js,ts,svelte,react,tailwind,bootstrap,cs,firebase,vite,prisma,git,vscode,postman,netlify,vercel&theme=dark)](https://skillicons.dev) <br>
## 🎨 Creative
